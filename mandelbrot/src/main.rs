...
use num::Complex;
use std::{str::FromStr, fs::File, env};
...
fn pixel_to_point(
    ...
    Complex {
        ...
        // subtraction here because pixel.1 increases as we go down, but the imaginary
...
fn main() {
    ...
    if args.len() != 5 {
        ...
        eprintln!("Example: {} mandel.png 100x750 -1.20,0.35 -1.0,0.20", args[0]);
        std::process::exit(1);
    }
    ...
    {
        // divide pixel buffers into bands with mutable non-overlapping slices
